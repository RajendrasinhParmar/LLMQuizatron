...
class TestForm:
    ...
    def render(self):
        ...
        test_name = st.text_input("Test Name", placeholder="e.g., Python Basics Test, JavaScript Fundamentals")
        ...
        with col2:
            technology = st.selectbox(
                ...
                [
                    ...
                    "Machine Learning", "Data Science", "DevOps", "Cybersecurity", "Web Development",
                    "Mobile Development", "Game Development", "Blockchain", "Cloud Computing"
                ]
            )
